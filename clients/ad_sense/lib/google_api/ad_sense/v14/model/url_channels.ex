...
defmodule GoogleApi.AdSense.V14.Model.UrlChannels do
  ...
  - kind (String): Kind of list this is, in this case adsense#urlChannels. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.AdSense.V14.Model.UrlChannels do
  ...
  def decode(value, options) do
    value
    |> deserialize(:items, :list, GoogleApi.AdSense.V14.Model.UrlChannel, options)
  end
end
