...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.ListBidMetricsResponse do
  ...
  - bidMetricsRows (List[BidMetricsRow]): List of rows, each containing a set of bid metrics. Defaults to: `null`.
  - nextPageToken (String): A token to retrieve the next page of results. Pass this value in the ListBidMetricsRequest.pageToken field in the subsequent call to the accounts.filterSets.bidMetrics.list method to retrieve the next page of results. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V2beta1.Model.ListBidMetricsResponse do
  ...
  def decode(value, options) do
    ...
    |> deserialize(
      :bidMetricsRows,
      :list,
      GoogleApi.AdExchangeBuyer.V2beta1.Model.BidMetricsRow,
      options
    )
  end
end
