...
defimpl Poison.Decoder, for: GoogleApi.AdSense.V14.Model.AdUnit do
  ...
  def decode(value, options) do
    ...
    |> deserialize(
      :contentAdsSettings,
      :struct,
      GoogleApi.AdSense.V14.Model.AdUnitContentAdsSettings,
      options
    )
    ...
    |> deserialize(
      :feedAdsSettings,
      :struct,
      GoogleApi.AdSense.V14.Model.AdUnitFeedAdsSettings,
      options
    )
    |> deserialize(
      :mobileContentAdsSettings,
      :struct,
      GoogleApi.AdSense.V14.Model.AdUnitMobileContentAdsSettings,
      options
    )
  end
end
