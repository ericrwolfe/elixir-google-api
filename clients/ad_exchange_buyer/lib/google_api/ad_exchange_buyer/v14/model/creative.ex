...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V14.Model.Creative do
  ...
  def decode(value, options) do
    ...
    |> deserialize(
      :corrections,
      :list,
      GoogleApi.AdExchangeBuyer.V14.Model.CreativeCorrections,
      options
    )
    |> deserialize(
      :filteringReasons,
      :struct,
      GoogleApi.AdExchangeBuyer.V14.Model.CreativeFilteringReasons,
      options
    )
    |> deserialize(
      :nativeAd,
      :struct,
      GoogleApi.AdExchangeBuyer.V14.Model.CreativeNativeAd,
      options
    )
    |> deserialize(
      :servingRestrictions,
      :list,
      GoogleApi.AdExchangeBuyer.V14.Model.CreativeServingRestrictions,
      options
    )
  end
end
