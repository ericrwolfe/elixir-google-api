...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V14.Model.MarketplaceDeal do
  ...
  def decode(value, options) do
    ...
    |> deserialize(
      :buyerPrivateData,
      :struct,
      GoogleApi.AdExchangeBuyer.V14.Model.PrivateData,
      options
    )
    |> deserialize(
      :dealServingMetadata,
      :struct,
      GoogleApi.AdExchangeBuyer.V14.Model.DealServingMetadata,
      options
    )
    |> deserialize(
      :deliveryControl,
      :struct,
      GoogleApi.AdExchangeBuyer.V14.Model.DeliveryControl,
      options
    )
    |> deserialize(
      :sellerContacts,
      :list,
      GoogleApi.AdExchangeBuyer.V14.Model.ContactInformation,
      options
    )
    |> deserialize(
      :sharedTargetings,
      :list,
      GoogleApi.AdExchangeBuyer.V14.Model.SharedTargeting,
      options
    )
