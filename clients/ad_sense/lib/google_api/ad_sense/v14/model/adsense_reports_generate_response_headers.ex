...
defmodule GoogleApi.AdSense.V14.Model.AdsenseReportsGenerateResponseHeaders do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AdSense.V14.Model.AdsenseReportsGenerateResponseHeaders do
  def decode(value, _options) do
    value
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdSense.V14.Model.AdsenseReportsGenerateResponseHeaders do
