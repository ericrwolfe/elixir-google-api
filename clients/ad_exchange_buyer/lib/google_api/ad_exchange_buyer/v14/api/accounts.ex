...
defmodule GoogleApi.AdExchangeBuyer.V14.Api.Accounts do
  ...
  """
  @spec adexchangebuyer_accounts_get(Tesla.Env.client(), Integer.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec adexchangebuyer_accounts_patch(Tesla.Env.client(), Integer.t(), keyword()) ::
          {:ok, GoogleApi.AdExchangeBuyer.V14.Model.Account.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec adexchangebuyer_accounts_update(Tesla.Env.client(), Integer.t(), keyword()) ::
          {:ok, GoogleApi.AdExchangeBuyer.V14.Model.Account.t()} | {:error, Tesla.Env.t()}
