...
defmodule GoogleApi.AdSense.V14.Model.SavedReports do
  @moduledoc """
  ...
  - kind (String): Kind of list this is, in this case adsense#savedReports. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.AdSense.V14.Model.SavedReports do
  import GoogleApi.AdSense.V14.Deserializer

  def decode(value, options) do
    value
    |> deserialize(:items, :list, GoogleApi.AdSense.V14.Model.SavedReport, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdSense.V14.Model.SavedReports do
