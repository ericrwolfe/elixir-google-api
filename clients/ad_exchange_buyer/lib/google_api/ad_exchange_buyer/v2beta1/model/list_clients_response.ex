...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.ListClientsResponse do
  ...
  - clients (List[Client]): The returned list of clients. Defaults to: `null`.
  - nextPageToken (String): A token to retrieve the next page of results. Pass this value in the ListClientsRequest.pageToken field in the subsequent call to the accounts.clients.list method to retrieve the next page of results. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V2beta1.Model.ListClientsResponse do
  ...
  def decode(value, options) do
    value
    |> deserialize(:clients, :list, GoogleApi.AdExchangeBuyer.V2beta1.Model.Client, options)
  end
end
