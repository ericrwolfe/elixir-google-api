...
defmodule GoogleApi.AdExchangeBuyer.V14.Api.BillingInfo do
  ...
  """
  @spec adexchangebuyer_billing_info_get(Tesla.Env.client(), Integer.t(), keyword()) ::
  ...
  def adexchangebuyer_billing_info_get(connection, account_id, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/billinginfo/{accountId}", %{
      "accountId" => URI.encode_www_form(account_id)
    })
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdExchangeBuyer.V14.Model.BillingInfo{})
  end
  ...
  def adexchangebuyer_billing_info_list(connection, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AdExchangeBuyer.V14.Model.BillingInfoList{})
  end
end
