...
defmodule GoogleApi.AdExchangeSeller.V20.Model.Report do
  ...
  - kind (String): Kind this is, in this case adexchangeseller#report. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeSeller.V20.Model.Report do
  ...
  def decode(value, options) do
    value
    |> deserialize(:headers, :list, GoogleApi.AdExchangeSeller.V20.Model.ReportHeaders, options)
  end
end
