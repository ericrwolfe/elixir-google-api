...
defmodule GoogleApi.AdExchangeSeller.V20.Model.UrlChannel do
  @moduledoc """
  ...
  - kind (String): Kind of resource this is, in this case adexchangeseller#urlChannel. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeSeller.V20.Model.UrlChannel do
  def decode(value, _options) do
    value
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdExchangeSeller.V20.Model.UrlChannel do
