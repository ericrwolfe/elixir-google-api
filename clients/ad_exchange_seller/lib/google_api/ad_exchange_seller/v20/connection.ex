...
defmodule GoogleApi.AdExchangeSeller.V20.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.AdExchangeSeller.V20.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug(Tesla.Middleware.BaseUrl, "https://www.googleapis.com/adexchangeseller/v2.0")
