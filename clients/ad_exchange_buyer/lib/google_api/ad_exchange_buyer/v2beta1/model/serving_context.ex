...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V2beta1.Model.ServingContext do
  ...
  def decode(value, options) do
    ...
    |> deserialize(
      :auctionType,
      :struct,
      GoogleApi.AdExchangeBuyer.V2beta1.Model.AuctionContext,
      options
    )
    |> deserialize(
      :location,
      :struct,
      GoogleApi.AdExchangeBuyer.V2beta1.Model.LocationContext,
      options
    )
    |> deserialize(
      :platform,
      :struct,
      GoogleApi.AdExchangeBuyer.V2beta1.Model.PlatformContext,
      options
    )
    |> deserialize(
      :securityType,
      :struct,
      GoogleApi.AdExchangeBuyer.V2beta1.Model.SecurityContext,
      options
    )
  end
end
