...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.TimeInterval do
  ...
  - endTime (String): The timestamp marking the end of the range (exclusive) for which data is included. Defaults to: `null`.
  - startTime (String): The timestamp marking the start of the range (inclusive) for which data is included. Defaults to: `null`.
  """
