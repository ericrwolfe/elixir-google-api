...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V14.Model.PretargetingConfig do
  ...
  def decode(value, options) do
    ...
    |> deserialize(
      :dimensions,
      :list,
      GoogleApi.AdExchangeBuyer.V14.Model.PretargetingConfigDimensions,
      options
    )
    |> deserialize(
      :excludedPlacements,
      :list,
      GoogleApi.AdExchangeBuyer.V14.Model.PretargetingConfigExcludedPlacements,
      options
    )
    |> deserialize(
      :placements,
    ...
    |> deserialize(
      :videoPlayerSizes,
      :list,
      GoogleApi.AdExchangeBuyer.V14.Model.PretargetingConfigVideoPlayerSizes,
      options
    )
  end
end
